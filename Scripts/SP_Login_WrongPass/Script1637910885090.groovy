...
WebUI.doubleClick(findTestObject('Object Repository/Page_UP Portal  HoChiMinh University of Pedagogy/a_ng nhp'))
...
WebUI.verifyTextPresent('"Mật mã truy cập không chính xác."', false)
